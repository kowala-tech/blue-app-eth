...
RUN apt-get update && apt-get -y install cmake git build-essential vim python python-pip wget libc6-i386 libc6-dev-i386
...
CMD cd /home && git clone --branch nanos-1421 https://github.com/LedgerHQ/nanos-secure-sdk.git && git clone --branch blue-r23 https://github.com/LedgerHQ/blue-secure-sdk.git && bash
